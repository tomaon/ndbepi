...
%%efine(BACKUP,                       16#00f4).
%%efine(DBTC,                         16#00f5). % 245
%%efine(DBDIH,                        16#00f6).
%%efine(DBLQH,                        16#00f7).
%%efine(DBACC,                        16#00f8).
%%efine(DBTUP,                        16#00f9).
%%efine(DBDICT,                       16#00fa). % 250
%%efine(NDBCNTR,                      16#00fb).
%%efine(CNTR,                         16#00fb).
-define(QMGR,                         16#00fc). % 252
%%efine(NDBFS,                        16#00fd).
%%efine(CMVMI,                        16#00fe).
%%efine(TRIX,                         16#00ff).
%%efine(DBUTIL,                       16#0100).
%%efine(SUMA,                         16#0101).
%%efine(DBTUX,                        16#0102).
%%efine(TSMAN,                        16#0103).
%%efine(LGMAN,                        16#0104).
%%efine(PGMAN,                        16#0105).
%%efine(RESTORE,                      16#0106).
%%efine(DBINFO,                       16#0107).
%%efine(DBSPJ,                        16#0108).
%%efine(THRMAN,                       16#0109).
%%efine(TRPMAN,                       16#010a).
...
%%efine(GSN_API_REGCONF,                    1).
%%efine(GSN_API_REGREF,                     2).
